...
BEGIN
  ...
  IF p_duration_seconds IS NOT NULL
     ...
     AND p_duration_seconds > v_ent.max_video_duration_seconds
     AND p_model NOT IN ('kling/ai-avatar-standard', 'kling/ai-avatar-pro', 'kling-3.0/motion-control', 'kling-2.6/motion-control') THEN
    RETURN jsonb_build_object(
      'allowed', false,
